...
int plot(char date[], char angle[])
{
    ...
    sprintf(filename_dat_2, "%s/dat_drift/%s_drift.dat",     date, angle);
    sprintf(filename_plot_1, "%s/plot/average/%s_loadcell_average.png", date, angle);
    sprintf(filename_plot_2, "%s/plot/average/%s_drag_average.png", date, angle);
    sprintf(filename_plot_3, "%s/plot/average/%s_lift_average.png", date, angle);
    // size
    size = 1;
