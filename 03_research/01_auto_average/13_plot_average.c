...
int plot(char date[], char angle[])
{
    ...
    sprintf(filename_plot_1, "result/%s/plot/average/%s_loadcell_average.png", date, angle);
    sprintf(filename_plot_2, "result/%s/plot/average/%s_drag_average.png", date, angle);
    sprintf(filename_plot_3, "result/%s/plot/average/%s_lift_average.png", date, angle);
    // size
    size = 1;
