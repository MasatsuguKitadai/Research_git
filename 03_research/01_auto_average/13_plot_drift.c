...
int plot(char date[], char angle[])
{
    ...
    sprintf(filename_plot_1, "%s/plot/drift/%s_loadcell_drift.png", date, angle);
    sprintf(filename_plot_2, "%s/plot/drift/%s_drag_drift.png", date, angle);
    sprintf(filename_plot_3, "%s/plot/drift/%s_lift_drift.png", date, angle);
