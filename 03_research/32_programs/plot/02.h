...
fprintf(gp, "plot '%s' using 1:2 with lines lc 'black' notitle, '%s' using 1:2 with points pt 5 ps 2 lc 'red' title 'start', '%s' using 1:2 with points pt 5 ps 2 lc 'blue' title 'finish', 0 lw 2 lc 'dark-grey' notitle\n", filename1, filename5, filename6);
