...
#include "files/file.h"
    ...
    fprintf(gp, "plot '%s' using 1:2 with lines lc 'black', '%s' using 1:2 with points pt 5 ps 2 lc 'red', '%s' using 1:2 with points pt 5 ps 2 lc 'red','%s' using 1:3 with points pt 5 ps 2 lc 'green','%s' using 1:3 with points pt 5 ps 2 lc 'green', '%s' using 1:2 with lines lw 2 lc 'green', '%s' using 1:3 with lines lc 'blue' , 0 lw 2 lc 'dark-grey'\n", filename1, filename5, filename6, filename5, filename6, filename7, filename7);
