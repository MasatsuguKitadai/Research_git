...
fprintf(gp, "plot 0 lw 2 lc 'dark-grey' notitle, '%s' using 1:3 with lines lw 2 lc 'orange' title 'Correction', '%s' using 1:3 with lines dt (10,5) lw 3 lc 'green' title 'Average'\n", filename7, filename8);
...
fprintf(gp, "plot 0 lw 2 lc 'dark-grey' notitle, '%s' using 1:5 with lines lw 2 lc 'orange' title 'Correction', '%s' using 1:5 with lines dt (10,5) lw 3 lc 'green' title 'Average'\n", filename7, filename8);
