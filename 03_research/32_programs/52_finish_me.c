...
#include "files/median.h"
    ...
    while ((fscanf(fp4, "%d\t%lf\t%lf", &num, &ch1, &ch2)) != EOF)
    {
        ...
        value_3[i][1] = ch1;
        value_3[i][2] = ch2;
        // printf("%d\t%lf\t%lf\n", number[i], value_3[i][1], value_3[i][2]);
        i = i + 1;
    }
    ...
    for (i = 200; i < range; i++)
    {
        ...
        if (ave2 < bottom)
        {
            ...
            finish_value_3[1] = value_3[finish_num][1];
            break;
        }
    }
    ...
    finish_value_3[2] = value_3[finish_num][2];
    ...
    fprintf(fp6, "%d\t%lf\t%lf\t%lf\t%lf\t%d\n", finish_num, finish_value_3[1], ave[1], finish_value_3[2], ave[2], ave_num);
