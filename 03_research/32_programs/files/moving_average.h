...
// 終了点特定 (1)
sprintf(filename6, "..//33_result//%s//moving_average//%d//dat//%s_ma(%d).dat", date, range_ma, name, range_ma);
sprintf(filename7, "..//33_result//%s//moving_average//%d//finish_point//%s_ma(%d)_sp.dat", date, range_ma, name, range_ma);
