...
const char graphname1[100] = "graph/01_sin_n=128.png";
const char graphname2[100] = "graph/02_sin_n=256.png";
const char graphname3[100] = "graph/03_sin_n=128_fft.png";
const char graphname4[100] = "graph/04_sin_n=256_fft.png";
...
int main()
{
    ...
    fprintf(gp, "set ylabel 'amplitude [-]' offset 0,0\n");
    fprintf(gp, "set title 'Test Sin Wave (n = 128)'\n");
    ...
    fprintf(gp, "set yrange [-5:5]\n");
    fprintf(gp, "set ylabel 'amplitude [-]' offset 0,0\n");
    fprintf(gp, "set title 'Test Sin Wave (n = 256)'\n");
    ...
    fprintf(gp, "set ylabel 'power spectrum [-]' offset 0.0\n");
