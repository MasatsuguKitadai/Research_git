...
{
    // ファイル名の指定
    char filename1[100] = "../31_data/calibration/load.csv";
    char filename2[100] = "../31_data/calibration/x-axis.csv";
    char filename3[100] = "../31_data/calibration/y-axis.csv";

    char filename4[100] = "../31_data/calibration/dat/load.dat";
    char filename5[100] = "../31_data/calibration/dat/x-axis.dat";
    char filename6[100] = "../31_data/calibration/dat/y-axis.dat";
