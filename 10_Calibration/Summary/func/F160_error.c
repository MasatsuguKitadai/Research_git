...
int RMSE(char date[])
{
    ...
    sprintf(directoryname_dat, "../result/%s/dat/30_Error", date);
    sprintf(directoryname_csv, "../result/%s/csv/30_Error", date);
    ...
    sprintf(filename_read_1, "../result/%s/csv/09-3_net-voltage/09-3.csv", date);
    sprintf(filename_read_2, "../result/%s/csv/21_adjust-value_ver2/21.csv", date);
    sprintf(filename_read_3, "../result/%s/csv/05-1_summary/05-1.csv", date);

    sprintf(filename_csv, "../result/%s/csv/30_Error/30.csv", date);
    sprintf(filename_dat, "../result/%s/dat/30_Error/30.dat", date);
