...
int DFT_lift(char date[], int range)
{
    // ディレクトリの作成
    ...
    sprintf(directoryname, "../Result/%s/110_DFT_lift", date);
    mkdir(directoryname, mode);

    /*****************************************************************************/

    sprintf(directoryname_dat, "../Result/%s/110_DFT_lift/dat", date);
    sprintf(directoryname_csv, "../Result/%s/110_DFT_lift/csv", date);
    sprintf(directoryname_png, "../Result/%s/110_DFT_lift/png", date);
    ...
    sprintf(filename_csv, "../Result/%s/110_DFT_lift/csv/DFT_lift.csv", date);
    sprintf(filename_dat, "../Result/%s/110_DFT_lift/dat/DFT_lift.dat", date);
    ...
    sprintf(filename_dat, "../Result/%s/110_DFT_lift/dat/DFT_lift.dat", date);
    sprintf(filename_png, "../Result/%s/110_DFT_lift/png/DFT_lift.png", date);
