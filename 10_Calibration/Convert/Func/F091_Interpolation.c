...
int Interpolation(char date[], int split)
{
    ...
    sprintf(filename_csv_average, "../Result/%s/091_Interpolation/csv/Interpolation-Ave.csv", date);
    sprintf(filename_dat_average, "../Result/%s/091_Interpolation/dat/Interpolation-Ave.dat", date);
