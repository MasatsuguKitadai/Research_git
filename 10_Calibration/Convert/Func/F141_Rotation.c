int Rotation(char date[], int split)
{
    ...
    sprintf(filename_read_1, "../../Phase-2/Result/%s/120_Phase-angle_drag/csv/Phase-angle_drag.csv", date);
    sprintf(filename_read_2, "../../Phase-2/Result/%s/130_Phase-angle_lift/csv/Phase-angle_lift.csv", date);
    ...
    sprintf(filename_csv_average, "../Result/%s/141_Rotation/csv/Rotation-Ave.csv", date);
    sprintf(filename_dat_average, "../Result/%s/141_Rotation/dat/Rotation-Ave.dat", date);
