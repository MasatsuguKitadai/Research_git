...
int Adjust(char date[])
{
    ...
    sprintf(directoryname, "../Result/%s/151_Adjust", date);
    mkdir(directoryname, mode);

    /*****************************************************************************/

    sprintf(directoryname_dat, "../Result/%s/151_Adjust/dat", date);
    sprintf(directoryname_csv, "../Result/%s/151_Adjust/csv", date);
    sprintf(directoryname_png, "../Result/%s/151_Adjust/png", date);
    ...
    sprintf(filename_read, "../../Phase-2/Result/%s/060_Summary/csv/Summary-Ave.csv", date);
    sprintf(filename_csv, "../Result/%s/151_Adjust/csv/Adjust.csv", date);
    sprintf(filename_dat_1, "../Result/%s/151_Adjust/dat/Adjust.dat", date);
    sprintf(filename_dat_2, "../Result/%s/151_Adjust/dat/Adjust-plot.dat", date);
    ...
    sprintf(filenname_convert, "../Result/%s/180_Force/csv/Force.csv", date);
    ...
    for (i = 0; i < max; i++)
    {
        wave_drag[i] = wave_drag[i] * average_value * convert;
        // printf("value[%d] = %.3f\n", i, wave_drag[i]);
    }
    ...
    for (i = 0; i < max; i++)
    {
        wave_lift[i] = wave_lift[i] * average_value * convert;
        // printf("value[%d] = %.3f\n", i, wave_lift[i]);
    }
    ...
    sprintf(filename_dat_3, "../Result/%s/151_Adjust/dat/Adjust-plot.dat", date);
    ...
    sprintf(filename_plot_1, "../Result/%s/151_Adjust/png/Raw-data_drag.png", date);
    sprintf(filename_plot_2, "../Result/%s/151_Adjust/png/Raw-data_lift.png", date);
    sprintf(filename_plot_3, "../Result/%s/151_Adjust/png/Rotation_drag.png", date);
    sprintf(filename_plot_4, "../Result/%s/151_Adjust/png/Rotation_lift.png", date);
    sprintf(filename_plot_5, "../Result/%s/151_Adjust/png/Offset_drag.png", date);
    sprintf(filename_plot_6, "../Result/%s/151_Adjust/png/Offset_lift.png", date);
    sprintf(filename_plot_7, "../Result/%s/151_Adjust/png/Interpolated_drag.png", date);
    sprintf(filename_plot_8, "../Result/%s/151_Adjust/png/Interpolated_lift.png", date);
    sprintf(filename_plot_9, "../Result/%s/151_Adjust/png/Summary.png", date);
