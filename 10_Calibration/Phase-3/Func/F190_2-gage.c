...
int twogage(char date[], int split, double phi_1, double phi_2)
{
    ...
    sprintf(directoryname_png, "../Result/%s/190_2-gage/png", date);
    ...
    sprintf(filename_plot_1, "../Result/%s/190_2-gage/png/Gradient.png", date);
    sprintf(filename_plot_2, "../Result/%s/190_2-gage/png/Voltage.png", date);
    ...
    fprintf(gp, "plot '%s' using 1:4 with points lc 'green' pt 5 ps 2 notitle, '%s' using 1:4 with lines lc 'gray40' title 'Average', '%s' using 1:5 with lines lc 'gray40' notitle, '%s' using 1:6 with lines lc 'gray40' notitle\n", filename_dat, filename_dat_average, filename_dat_average, filename_dat_average);
    fflush(gp); // Clean up Data
