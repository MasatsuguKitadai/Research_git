...
int phase_angle_drag_theory(char date[])
{
    ...
    sprintf(directoryname_dat, "../result/%s/dat/28-3_phase-angle_drag-theory", date);
    sprintf(directoryname_csv, "../result/%s/csv/28-3_phase-angle_drag-theory", date);
    ...
    sprintf(filename_read, "../result/%s/csv/27-3_dft-drag-theory/27-3.csv", date);
    sprintf(filename_csv, "../result/%s/csv/28-3_phase-angle_drag-theory/28-3.csv", date);
    sprintf(filename_dat, "../result/%s/dat/28-3_phase-angle_drag-theory/28-3.dat", date);
    ...
    sprintf(filename_read_result, "../result/%s/csv/08-3_phase-angle_drag/08-3.csv", date);
