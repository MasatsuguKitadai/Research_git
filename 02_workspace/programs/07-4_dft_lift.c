...
int calculate_lift(char date[], int range)
{
    ...
    sprintf(directoryname_dat, "../result/%s/dat/07-4_dft-lift", date);
    sprintf(directoryname_csv, "../result/%s/csv/07-4_dft-lift", date);
    ...
    sprintf(filename_dat, "../result/%s/dat/07-4_dft-lift/07-4.dat", date);
    sprintf(filename_plot, "../result/%s/plot/07/07-4_dft-lift.png", date);
