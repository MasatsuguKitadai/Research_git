...
int phase_angle_lift(char date[])
{
    ...
    sprintf(directoryname_dat, "../result/%s/dat/08-4_phase-angle_lift", date);
    sprintf(directoryname_csv, "../result/%s/csv/08-4_phase-angle_lift", date);
    ...
    sprintf(filename_read, "../result/%s/csv/07-4_dft-lift/07-4.csv", date);
    sprintf(filename_csv, "../result/%s/csv/08-4_phase-angle_lift/08-4.csv", date);
    sprintf(filename_dat, "../result/%s/dat/08-4_phase-angle_lift/08-4.dat", date);
