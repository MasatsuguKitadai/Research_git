...
int calculate_drag_theory(char date[], int range)
{
    ...
    sprintf(directoryname_dat, "../result/%s/dat/27-1_fft-drag-theory", date);
    sprintf(directoryname_csv, "../result/%s/csv/27-1_fft-drag-theory", date);
    ...
    sprintf(filename_csv, "../result/%s/csv/27-1_fft-drag-theory/27-1.csv", date);
