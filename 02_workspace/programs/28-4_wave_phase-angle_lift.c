...
int phase_angle_lift_theory(char date[])
{
    ...
    sprintf(directoryname_dat, "../result/%s/dat/28-4_phase-angle_lift-theory", date);
    sprintf(directoryname_csv, "../result/%s/csv/28-4_phase-angle_lift-theory", date);
    ...
    sprintf(filename_read, "../result/%s/csv/27-4_dft-lift-theory/27-4.csv", date);
    sprintf(filename_csv, "../result/%s/csv/28-4_phase-angle_lift-theory/28-4.csv", date);
    sprintf(filename_dat, "../result/%s/dat/28-4_phase-angle_lift-theory/28-4.dat", date);
