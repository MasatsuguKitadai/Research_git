...
int calculate_drag_theory(char date[], int range)
{
    ...
    sprintf(directoryname_dat, "../result/%s/dat/27-3_dft-drag-theory", date);
    sprintf(directoryname_csv, "../result/%s/csv/27-3_dft-drag-theory", date);
    ...
    sprintf(filename_csv, "../result/%s/csv/27-3_dft-drag-theory/27-3.csv", date);
...
// int main()
// {
//     calculate_drag_theory("test-dft", 16);
