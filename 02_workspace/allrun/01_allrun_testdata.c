...
// #include "../programs/09-1_net-voltage_ver2.c"
// #include "../programs/21-1/_wave-adjuster_ver2.c"
...
#include "../programs/09-2_net-voltage_ver2.c"
#include "../programs/21-2_wave-adjuster_ver2.c"
...
int main()
{
    ...
    // 09_net-voltage
    netvoltage(dataname, split_angle);
