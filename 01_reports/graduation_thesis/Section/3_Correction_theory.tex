...
このとき，作用力$F$は，Fig.に示す点$v$の座標を表すベクトルと考えることができる．
...
Fig. より，波数1についてピークがあることがわかり，データの特徴を正しく捉えられているといえる．
...
ここでは，回転角はなく，水槽座標系の中心oと座標系Bの中心o''はオフセット$\Delta x$，$\Delta y$を持つ．
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \subcaption{Offset Corrected gradient [Case 7]}
  \end{center}
\end{figure}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \subcaption{interpolated data [Case 7]}
  \end{center}
\end{figure}
...
Fig.をみると，テストデータ[Case 7]における正味出力電圧はおおよそ一定になることがわかる．
