...
\begin{figure}[htbp]
	\footnotesize
	\begin{center}
		\includegraphics[width=100mm]{images/31-1.png}
		\caption{}
	\end{center}
\end{figure}
...
座標系のオフセットにおける補正理論を用いた補正処理では，水槽座標系における作用力とその角度が算出される．
